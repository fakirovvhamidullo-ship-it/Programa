  ...
  if (type === 'python') {
    return (
      <Cover id="python">
        ...
        <path d="M118 46h62c22 0 28 14 28 28v18H132c-20 0-28-10-28-24 0-14 4-22 14-22z" fill="var(--ink-gold)" />
        <path d="M242 122h-62c-22 0-28-14-28-28V76h76c20 0 28 10 28 24 0 14-4 22-14 22z" fill="var(--ink-blue)" />
